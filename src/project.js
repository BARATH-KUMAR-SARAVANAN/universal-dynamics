...
class MainLayout extends Component {
  static contextType = ThemeContext; // To access ThemeContext
        ...
        <div>
          <nav
            className={`navbar navbar-expand-lg ${
              theme === 'Dark Theme' ? 'bg-dark navbar-dark' : 'navbar-light'
            }`}
          >
            ...
            <a href="/" className="navbar-brand" style={{ position: 'relative' }} id="ud-brand">
              UD
            </a>
            <a href="/" className="navbar-brand" style={{ position: 'relative' }} id="universal-brand">
              Universal Dynamics
            </a>
            ...
            <div className="d-flex align-items-center">
              ...
              >
                <i
                  className={theme === 'Dark Theme' ? 'bi bi-sun-fill' : 'bi bi-moon-fill'}
                  style={{ fontSize: '24px' }}
                ></i>
              </button>
            </div>
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
              <ul className="navbar-nav ml-auto mt-2 mt-lg-0" style={{ marginLeft: 'auto', padding: '12px' }}>
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/EVehicles">
                    E-Vehicles
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/sportscars">
                    SportsCars
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/vintage">
                    VintageCars
                  </Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item" onClick={this.clickLogout}>
                  Log out
                </li>
              </ul>
            </div>
